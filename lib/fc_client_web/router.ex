defmodule FcClientWeb.Router do
  ...
  alias FcClientWeb.EnsureRolePlug
  ...
  pipeline :owner do
    plug EnsureRolePlug, [:owner, :manager, :admin]
  end
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, html: {FcClientWeb.Layouts, :root}
  ...
  # scope "/api", FcClientWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:fc_client, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: FcClientWeb.Telemetry
  ...
  scope "/", FcClientWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{FcClientWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", FcClientWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{FcClientWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", FcClientWeb do
    ...
    live_session :current_user,
      on_mount: [{FcClientWeb.UserAuth, :mount_current_user}] do
